...
class Style_dubber_model_loss_15_Emo(nn.Module):
    ...
    def forward(self, texts, speaker_targets, mel_targets, pitch_targets, energy_targets, mel_lens, duration_targets, ref_linguistic_targets, mel_predictions, postnet_mel_predictions, log_duration_predictions, src_masks, mel_masks, ref_mel_masks, speaker_predicts, spk_embedding, attn_scores, x_lengths, lip_length, lip_masks, emotion_id_embedding, emotion_id, nosie_loss):
        ...
        total_loss = (
            mel_loss + postnet_mel_loss + duration_loss + speaker_loss + diagonal_loss + emos_loss)
